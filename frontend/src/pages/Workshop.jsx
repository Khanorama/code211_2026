...
import { generateWorkshopResponse, workshopTools } from '../services/workshopService';
    ...
    <section className="page">
      <header className="page-header page-header-workshop">
        <div>
          ...
          <p className="lead">
            Switch between essay support, outreach emails, and application guidance. Responses are generated by AI using your saved profile.
          </p>
        </div>
      </header>
            ...
            {response ? (
              <div className="response-panel">
                <div className="response-panel__header">
                  ...
                  <span className="tag tag--soft">AI</span>
                </div>
                ...
                <div className="stack">
                  {response.sections.map((section) => (
                    <article key={section.label} className="response-block">
                      <h3>{section.label.replace(/\*\*/g, '').replace(/^#+\s*/, '').trim()}</h3>
              ...
              <div className="empty-state">
                <h2>No draft yet</h2>
                <p>Enter a prompt and generate a response for the selected workshop tool.</p>
              </div>
            )}
          </section>
